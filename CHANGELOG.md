...
- **First-Run Web Handoff Hardening**: `strada setup` now retries the post-save web launch automatically, keeps the browser recovery path clearer when config was already saved, and avoids a dead second Save against a torn-down setup server
