...
La memoria ahora tambien se separa por rol: user profile state guarda nombre/preferencias/autonomy, task execution memory guarda session summaries/open items/rollback state, y project/world memory permanece en AgentDB analysis y semantic retrieval.
