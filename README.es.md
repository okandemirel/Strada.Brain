...
El setup de terminal ahora puede agregar varios proveedores de respuesta uno por uno para fallback u orquestacion multiagente, mientras mantiene separada la eleccion del proveedor de embeddings.
