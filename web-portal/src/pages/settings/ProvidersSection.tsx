...
export default function ProvidersSection() {
  ...
  return (
    <div>
      <h2 className="text-lg font-semibold text-text mb-1">Providers</h2>
      <p className="text-sm text-text-tertiary mb-6">Configure AI providers and models</p>
      ...
      <div className="bg-white/3 backdrop-blur border border-white/5 rounded-2xl p-5 mb-4">
        <div className="flex items-center justify-between mb-3">
          <span className="text-sm font-medium text-text">Active Worker</span>
