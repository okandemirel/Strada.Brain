...
>(({ className, children, hideClose = false, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        'fixed left-1/2 top-1/2 z-50 w-full max-w-lg -translate-x-1/2 -translate-y-1/2 rounded-xl border border-white/10 bg-bg-secondary/90 backdrop-blur-xl p-6 shadow-2xl focus:outline-none',
        className
      )}
      {...props}
    >
