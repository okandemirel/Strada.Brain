...
Hafiza artik role gore ayrilir: user profile state ad/tercih/autonomy bilgisini, task execution memory session summaries/open items/rollback state bilgisini, project/world memory ise AgentDB analysis ve semantic retrieval katmanlarini tutar.
