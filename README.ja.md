...
Strada.Brain は [Strada.MCP](https://github.com/okandemirel/Strada.MCP)（76 ツールの Unity MCP サーバー）を検出し、ランタイム制御、ファイル操作、git、.NET ビルド、コード分析、シーン/プレハブ管理を含む利用可能な MCP 機能についてエージェントに通知します。
