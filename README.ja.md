...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-4100%2B-brightgreen?style=flat-square" alt="テスト">
...
**技術スタック：** React 19、Vite、Tailwind CSS v4、Zustand、TanStack Query、Radix UI、ReactFlow、tldraw、Monaco Editor。
