...
メモリも役割ごとに分離されました。user profile state は名前/設定/autonomy、task execution memory は session summaries/open items/rollback state、project/world memory は AgentDB analysis と semantic retrieval に残ります。
