...
Strada.Brain は毎日自動的に更新をチェックし、アイドル時に適用します。source checkout と `./strada install-command` インストールは git 経由で更新されます。npm ベースの更新コマンドは public npm release が存在する場合にのみ有効です。
