...
export class SecurityMonitor {
    ...
    recordEvent(
        ...
        if (options.alertImmediately !== false && (severity === 'critical' || type === 'brute_force_attempt')) {
    ...
    recordSuspiciousRequest(
        ...
        this.recordEvent(
            ...
            options.type === 'sql_injection' || options.type === 'command_injection' ? 'critical' : 'warning',
            'request_filter',
