export type MessageKey = "provider_slow" | "provider_failing" | "provider_backoff" | "provider_ask_user" | "provider_abort" | "task_stuck" | "token_budget_exceeded" | "max_steps_reached";
