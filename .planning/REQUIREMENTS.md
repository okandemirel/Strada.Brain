...
- [ ] **MEM-01**: AgentDB replaces FileMemoryManager as the memory backend in bootstrap
...
- [ ] **EVAL-07**: Confidence threshold gap enforced (new patterns start at max 0.5, not 0.8) to prevent premature promotion
...
|-------------|-------|--------|
| MEM-01 | Phase 1: AgentDB Activation | Pending |
...
| EVAL-07 | Phase 6: Bayesian Confidence System | Pending |
