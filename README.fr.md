...
La m&eacute;moire est maintenant s&eacute;par&eacute;e par r&ocirc;le : user profile state garde nom/pr&eacute;f&eacute;rences/autonomy, task execution memory garde session summaries/open items/rollback state, et project/world memory est maintenant inject&eacute; explicitement &agrave; partir du project root actif plus la AgentDB analysis en cache, pendant que semantic retrieval ajoute toujours la m&eacute;moire pertinente en direct s&eacute;par&eacute;ment.
