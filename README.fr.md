...
| `/routing info` | Afficher les d&eacute;cisions de routage r&eacute;centes, les traces d'ex&eacute;cution r&eacute;elles, les phase outcomes et les adaptive phase scores pour l'identit&eacute; active, avec verifier clean rate, rollback pressure, retry count, token-cost telemetry, provider catalog freshness et official alignment / capability drift sur planning, execution, clarification-review, review et synthesis |
