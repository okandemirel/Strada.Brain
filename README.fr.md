...
Strada conserve d&eacute;sormais aussi un execution journal et une rollback memory internes pour chaque t&acirc;che. Les replans peuvent r&eacute;utiliser le dernier checkpoint stable, m&eacute;moriser les branches &eacute;puis&eacute;es et renvoyer des adaptive phase scores vers le routing sans lore de fournisseur hardcod&eacute;.
...
| `/routing info` | Afficher les d&eacute;cisions de routage r&eacute;centes, les traces d'ex&eacute;cution r&eacute;elles, les phase outcomes et les adaptive phase scores pour l'identit&eacute; active, y compris planning, execution, clarification-review, review et synthesis |
